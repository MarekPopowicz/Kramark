				...
				<div  class="sidebar-item" >
					<div class="make-me-sticky">
						...
						<nav id="tmMainNav" class="tm-main-nav">
								<ul>
									<li>
										<a href="#"  id="tmNavLink1" class="scrolly" data-bg-img="computers_bg.jpg" 
											data-page="#tm-section-1">
											<i class="fa fa-laptop tm-nav-fa-icon" aria-hidden="true"></i>
									...
									<li>
										<a href="#" id="tmNavLink2" class="scrolly" data-bg-img="phones_bg.jpg" 
											data-page="#tm-section-2">
											<i class="fa fa-mobile tm-nav-fa-icon" aria-hidden="true"></i>
									...
									<li>
										<a href="#"  class="scrolly" data-bg-img="rtv_bg.jpg" 
											data-page="#tm-section-3">
											<i class="fa fa-desktop tm-nav-fa-icon" aria-hidden="true"></i>
											<span>RTV</span>
										</a>
									</li>
										<br>
