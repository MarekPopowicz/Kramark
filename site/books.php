				...
				<div  class="sidebar-item" >
					<div class="make-me-sticky">
						...
						<nav id="tmMainNav" class="tm-main-nav">
								<ul>
									<li>
										<a href="#"  id="tmNavLink1" class="scrolly" data-bg-img="books_bg.jpg" 
											data-page="#tm-section-1">
											<i class="fa fa-book tm-nav-fa-icon" aria-hidden="true"></i>
									...
									<li>
										<a href="#" id="tmNavLink2" class="scrolly" data-bg-img="dvd_bg.jpg" 
											data-page="#tm-section-2">
											<i class="fa fa-bullseye tm-nav-fa-icon" aria-hidden="true"></i>
									...
									<li>
										<a href="#"  class="scrolly" data-bg-img="cd_bg.jpg" 
